...
namespace UnitTests
{
    ...
    public class SocketSettingsTest
    {
        ...
        public void DefaultValues()
        {
            ...
            Assert.IsFalse(socketSettings.SocketIgnoreSystemProxy);
        ...
        private Dictionary BaseTestDict()
        {
            ...
            dict.SetBool(SessionSettings.SOCKET_IGNORE_SYSTEM_PROXY, true);
        ...
        public void Configure()
        {
            ...
            Assert.IsTrue(socketSettings.SocketIgnoreSystemProxy);
